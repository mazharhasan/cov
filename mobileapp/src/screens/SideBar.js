...
export default class SideBar extends Component {
  ...
  _retrieveData = async () => {
          ...
          this.setState({datas : [
            { id: '1', name: "Home", key: "Home", icon:<Entypo name={'home'} color={'#4195d1'} size={17}/>},
            { id: '2', name: "Risk Assesment", key: "MyProfile",icon:<Entypo name={'user'} color={'#4195d1'} size={17}/>  },
            { id: '5', name: "Patients", key: "MyOrders",icon:<MaterialIcons name={'settings-backup-restore'} color={'#4195d1'} size={17}/>  },
